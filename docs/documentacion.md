...
│   │   │   │                               filters por mes, timeline premium y counters animados.
│   │   │   ├── festival-calendar.html    → Header con icono, chips de mes, nodos de timeline,
│   │   │   │                               mini-cards flotantes y barra de estadísticas.
│   │   │   ├── festival-calendar.scss    → Glassmorphism claro, línea temporal horizontal con
│   │   │   │                               fallback vertical en móvil y microinteracciones.
│   │   │   └── festival-calendar.spec.ts → Tests de render, filtrado por mes y estado vacío.
│   │   ├── featured-festivals/
...
│   ├── festival-locations.ts → Array readonly de FestivalLocation con los 6 festivales semilla:
│   │                           key, claves i18n, startDate ISO, lat/lng, category, markerTone.
