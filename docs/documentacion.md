...
│   ├── autocommit.md        → Workflow de commits semánticos (Conventional Commits + pre-commit gate). Pregunta los nº de issue (0 para terminar) y los añade como (#n)
│   └── new-task.md          → Inicia tarea activa: lee un GitHub Issue y puebla tasks/current-task.md (Status: In Progress)
